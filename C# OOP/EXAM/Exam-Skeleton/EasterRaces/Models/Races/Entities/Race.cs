...
namespace EasterRaces.Models.Races.Entities
{
    ...
    {
        private const int RaceMinLen = 5;
        ...
        public string Name
        {
            ...
            private set
            {
                if (string.IsNullOrEmpty(value) || value.Length < RaceMinLen)
                {
                    throw new ArgumentException(string.Format(ExceptionMessages.InvalidName, value, RaceMinLen ));
                }
