...
namespace OrmFundamental.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<DDemo1> DDemo1s { get; set; }
        public virtual DbSet<Department> Departments { get; set; }
        public virtual DbSet<Employee> Employees { get; set; }
        public virtual DbSet<EmployeesProject> EmployeesProjects { get; set; }
        public virtual DbSet<EmployeesWithSalaryHigherThan30000> EmployeesWithSalaryHigherThan30000s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DDemo1>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("D_DEMO1");
            ...
            modelBuilder.Entity<EmployeesWithSalaryHigherThan30000>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("EmployeesWithSalaryHigherThan30000");
